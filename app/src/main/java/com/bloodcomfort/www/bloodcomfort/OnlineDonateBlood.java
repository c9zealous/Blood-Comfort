...
public class OnlineDonateBlood extends ActionBarActivity {
    Spinner spinner3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.onlinedonateblood);
        ...
        phoneNumber1 = (EditText) findViewById(R.id.phone1);
    ...
    public void facebookneedbutton(View view) {
        ...
        phonestr1 = phoneNumber1.getText().toString();

        if (phonestr1.equals("")) {
            //popup message
            Toast pass = Toast.makeText(OnlineDonateBlood.this, "Phone Field is Empty!", Toast.LENGTH_SHORT);
            pass.show();
        } else if (!phonestr1.equals("") && !face_name.equals("") && !face_email.equals("")) {


            BackgroundTask backgroundTask = new BackgroundTask(this);
            backgroundTask.execute(method, face_name, face_email, country, state, city, phonestr1,blood_type);
            finish();

        }else if(face_name.equals("") && face_email.equals("")){ Toast pass = Toast.makeText(OnlineDonateBlood.this, "Facebook Data Not Valid!", Toast.LENGTH_SHORT);
            pass.show();
    ...
    class BackgroundTask extends AsyncTask<String,Void,String> {
        ...
        @Override
        protected String doInBackground(String... params) {
            String reg_url ="http://www.bloodcomfort.com/facebook_register.php";
            ...
            if(method.equals("register")){
                ...
                String phonestr = params[6];
                String bloodstr = params[7];
                try {
        ...
        protected void onPostExecute(String result) {
            if (result.equals("Data insertion error...")) {
                ...
                Toast alert = Toast.makeText(OnlineDonateBlood.this,"Registration Successfull..." ,Toast.LENGTH_SHORT);
                alert.show();
                String face_name = getIntent().getStringExtra("face_name");

                Intent intent=new Intent(OnlineDonateBlood.this,ThankYou.class);
                intent.putExtra("json_data",face_name);
